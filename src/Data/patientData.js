...
export const symptomQuestions = [
    {
        id: 1,
        question: "Hôm nay bạn có cảm thấy khó thở không?",
        answer: "Ít",
    },
    {
        id: 2,
        question: "Bạn có bị đau tức ngực không?",
        answer: "Không",
    },
    {
        id: 3,
        question: "Tần suất ho hôm nay thế nào?",
        answer: "Giảm so với hôm qua",
    },
];

export const coughRecords = [
    {
        id: 1,
        time: "08:20 hôm nay",
        result: "Ho nhẹ",
        aiNote: "Âm thanh ho ít bất thường hơn hôm qua.",
    },
    {
        id: 2,
        time: "20:10 hôm qua",
        result: "Ho trung bình",
        aiNote: "Cần tiếp tục theo dõi tần suất ho.",
    },
];